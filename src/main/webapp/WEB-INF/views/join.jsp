...
<article>
	...
	<form id="formm" name="formm" method="post">
		<br /> ID: <input type="text" name="mem_id"> <input
			type="button" value="중복 체크" onclick="idcheck()"><br /> PW1:
		<input type="password" name="mem_pwd"><br /> PW2: <input
			type="password" name="mem_pwd2"><br /> NAME: <input
			type="text" name="mem_nm"><br /> E-MAIL: <input type="text"
			name="mem_email"><br /> PHONE: <input type="text"
			name="mem_phone"><br />
		...
		<button type="button" id="btnContactUs" onclick="go_save()">계정생성</button>
